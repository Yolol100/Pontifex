 ...
 * BTW: ALLES = 21% (0.21) – wettelijk vanaf 2026
 * ------------------------------------------- */
$EXTRA_PRODUCTS = [
    // 🇳🇱 Basis NL
    'vca_proefexamen_nl' => [
    ...
    // Vertaalde/aliassen
    'cursus-weekend'             => ['label' => 'Weekendcursus met examen',      'price' => 245,    'vat' => 0.21],
    'vca-basis-proefexamens-nl'  => ['label' => 'VCA Basis Proefexamens (NL)',   'price' => 25,     'vat' => 0.21],
    'vca-vol-proefexamens-nl'    => ['label' => 'VCA Vol Proefexamens (NL)',     'price' => 25,     'vat' => 0.21],
    'proefexamens-en'            => ['label' => 'Proefexamens (EN)',             'price' => 25.00,  'vat' => 0.21],
];

/* -------------------------------------------
 * EXAMENSOORTEN ($EXAM_PRODUCTS)
 * Examenprijzen worden behandeld als 21% in de PaymentHelpers.
 * ------------------------------------------- */
$EXAM_PRODUCTS = [
    // VCA Basis
...
$MATERIAL_PRODUCTS = [
    // BASIS NL
    'e-learning-vca-basis-nl'     => ['label' => 'E-learning met proefexamen (NL)',   'price' => 29,   'vat' => 0.21],
    'vca-basis-proefexamens-nl'   => ['label' => 'VCA Basis Proefexamens (NL)',       'price' => 25,   'vat' => 0.21],
    'boek-vca-basis-nl'           => ['label' => 'Boek VCA Basis (NL)',               'price' => 36,   'vat' => 0.21],
    'boek-vca-combi-nl'           => ['label' => 'Boek VCA Combi (NL)',               'price' => 49,   'vat' => 0.21],

    // VOL NL
    'e-learning-vca-vol-nl'       => ['label' => 'E-learning met proefexamen (NL)',   'price' => 39,   'vat' => 0.21],
    'vca-vol-proefexamens-nl'     => ['label' => 'VCA Vol Proefexamens (NL)',         'price' => 25,   'vat' => 0.21],
    'boek-vca-vol-nl'             => ['label' => 'Boek VCA Vol (NL)',                 'price' => 42,   'vat' => 0.21],
    'boek-vca-combi-vol-nl'       => ['label' => 'Boek VCA Combi (NL)',               'price' => 49,   'vat' => 0.21],

    // BASIS EN
    'e-learning-vca-basis-en'     => ['label' => 'E-learning met proefexamen (EN)',   'price' => 49,   'vat' => 0.21],
    'boek-vca-basis-en'           => ['label' => 'Boek VCA Basis (EN)',               'price' => 56,   'vat' => 0.21],
    'boek-vca-combi-en'           => ['label' => 'Boek VCA Combi (EN)',               'price' => 69,   'vat' => 0.21],

    // VOL EN
    'e-learning-vca-vol-en'       => ['label' => 'E-learning met proefexamen (EN)',   'price' => 59,   'vat' => 0.21],
    'boek-vca-vol-en'             => ['label' => 'Boek VCA Vol (EN)',                 'price' => 62,   'vat' => 0.21],
    'boek-vca-combi-vol-en'       => ['label' => 'Boek VCA Combi (EN)',               'price' => 69,   'vat' => 0.21],
...
function pontifex_oi_get_product_data_for_js() {
    ...
    foreach ($EXTRA_PRODUCTS as $k => $v) {
        $isProef = (stripos($k, 'proefexamen') !== false)
            || (stripos($v['label'] ?? '', 'proef') !== false)
            || (stripos($v['label'] ?? '', 'practice') !== false);
