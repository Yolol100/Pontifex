...
/* -------------------------------------------
 * PRODUCT CONFIGURATIE - Prijzen en BTW
 *
 * BELANGRIJK: Alle producten worden afgerekend tegen 21% BTW.
 * De 'vat'-sleutel is legacy en wordt NIET meer gebruikt in de berekeningen.
 * Zie PaymentHelpers::calculate_totals_with_vat() voor de actuele logica.
 * De 'vat'-sleutel is behouden voor backwards compatibility, JS-weergave
 * en exports, maar de waarde heeft geen invloed meer op de prijsberekening.
 * ------------------------------------------- */
...
$EXTRA_PRODUCTS = [
    ...
    // Vertaalde/aliassen
    'cursus-weekend' => [
        'label' => 'Weekendcursus met examen',
        'price' => 245.00,
        'vat'   => 0.21 // 21%
    ],
    'vca-basis-proefexamens-nl' => [
        'label' => 'VCA Basis Proefexamens (NL)',
        'price' => 25.00,
        'vat'   => 0.21 // 21%
    ],
    'vca-vol-proefexamens-nl' => [
        'label' => 'VCA Vol Proefexamens (NL)',
        'price' => 25.00,
        'vat'   => 0.21 // 21%
    ],
    'proefexamens-en' => [
 ...
 * Examenprijzen bevatten geen 'vat'-sleutel → altijd 21% in PaymentHelpers
 * ------------------------------------------- */
$EXAM_PRODUCTS = [
    // VCA Basis
 ...
 * Alle producten → 21% BTW in de praktijk
 * 'vat' is legacy veld → altijd 0.21 zetten voor consistentie
 * ------------------------------------------- */
$MATERIAL_PRODUCTS = [
    // BASIS NL
    'e-learning-vca-basis-nl' => [
        'label' => 'E-learning met proefexamen (NL)',
        'price' => 29,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'vca-basis-proefexamens-nl' => [
    ...
    'boek-vca-basis-nl' => [
        'label' => 'Boek VCA Basis (NL)',
        'price' => 36,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-combi-nl' => [
        'label' => 'Boek VCA Combi (NL)',
        'price' => 49,
        'vat'   => 0.21 // 21% (legacy veld)
    ],

    // VOL NL
    'e-learning-vca-vol-nl' => [
        'label' => 'E-learning met proefexamen (NL)',
        'price' => 39,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    ...
    'boek-vca-vol-nl' => [
        'label' => 'Boek VCA Vol (NL)',
        'price' => 42,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-combi-vol-nl' => [
        'label' => 'Boek VCA Combi (NL)',
        'price' => 49,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    ...
    // BASIS EN
    'e-learning-vca-basis-en' => [
        'label' => 'E-learning met proefexamen (EN)',
        'price' => 49,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-basis-en' => [
        'label' => 'Boek VCA Basis (EN)',
        'price' => 56,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-combi-en' => [
        'label' => 'Boek VCA Combi (EN)',
        'price' => 69,
        'vat'   => 0.21 // 21% (legacy veld)
    ],

    // VOL EN
    'e-learning-vca-vol-en' => [
        'label' => 'E-learning met proefexamen (EN)',
        'price' => 59,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-vol-en' => [
        'label' => 'Boek VCA Vol (EN)',
        'price' => 62,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
    'boek-vca-combi-vol-en' => [
        'label' => 'Boek VCA Combi (EN)',
        'price' => 69,
        'vat'   => 0.21 // 21% (legacy veld)
    ],
