...
$material  = isset($_GET['material'])  ? sanitize_text_field(wp_unslash($_GET['material']))  : '1';
...
$direct_link_mode = isset($_GET['extra_option']) ? sanitize_text_field(wp_unslash($_GET['extra_option'])) : '';
...
$url_price = isset($_GET['price']) ? sanitize_text_field(wp_unslash($_GET['price'])) : '';
$url_price_numeric = 0;
if (!empty($url_price)) {
